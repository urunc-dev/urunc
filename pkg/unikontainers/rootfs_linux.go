...
// Linux realization of the guest rootfs decision: the monitor's execution
// rootfs (bind mounts, device nodes, console) and the pivot into it. Nothing
// here has a darwin counterpart; the darwin runner hands the rootfs to the
// VMM directly.
