...
func (n DynamicNetwork) NetworkSetup(uid uint32, gid uint32, queues int) (*UnikernelNetworkInfo, error) {
	...
	newTapDevice, err := networkSetup(newTapName, "", redirectLink, true, uid, gid, queues)
	if err != nil {
