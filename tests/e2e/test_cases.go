...
func nerdctlTestCases() []containerTestArgs {
	return []containerTestArgs{
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/caddy-qemu-freebsd-raw:latest",
			Name:           "Qemu-freebsd-caddy-9pfs",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/caddy-firecracker-freebsd-raw:latest",
			Name:           "Firecracker-freebsd-caddy-devmapper",
			Devmapper:      true,
			Seccomp:        true,
			UID:            0,
			GID:            0,
...
func dockerTestCases() []containerTestArgs {
	return []containerTestArgs{
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/caddy-qemu-freebsd-block:latest",
			Name:           "Qemu-freebsd-caddy-block",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/caddy-firecracker-freebsd-block:latest",
			Name:           "Firecracker-freebsd-caddy-block",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
